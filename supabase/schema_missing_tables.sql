-- ═══════════════════════════════════════════════════════════════
-- Hiányzó táblák és oszlopok – Egyszeri futtatás
...
SELECT 'OK – minden tábla és oszlop létrehozva' AS status;
